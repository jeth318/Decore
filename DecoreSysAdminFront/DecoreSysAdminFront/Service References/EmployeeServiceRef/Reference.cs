...
namespace DecoreSysAdminFront.EmployeeServiceRef {
    ...
    public partial class EmployeeInfo : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private DecoreSysAdminFront.EmployeeServiceRef.RoleInfo RoleField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public DecoreSysAdminFront.EmployeeServiceRef.RoleInfo Role {
            get {
    ...
    public interface IService1 {
        ...
        DecoreSysAdminFront.EmployeeServiceRef.EmployeeInfo CreateEmployee(int userIdIn, int createdByIdin, int[] sectionIdsIn, int[] roleIdsIn);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/CreateEmployee", ReplyAction="http://tempuri.org/IService1/CreateEmployeeResponse")]
        System.Threading.Tasks.Task<DecoreSysAdminFront.EmployeeServiceRef.EmployeeInfo> CreateEmployeeAsync(int userIdIn, int createdByIdin, int[] sectionIdsIn, int[] roleIdsIn);
    }
    ...
    public partial class Service1Client : System.ServiceModel.ClientBase<DecoreSysAdminFront.EmployeeServiceRef.IService1>, DecoreSysAdminFront.EmployeeServiceRef.IService1 {
        ...
        public DecoreSysAdminFront.EmployeeServiceRef.EmployeeInfo CreateEmployee(int userIdIn, int createdByIdin, int[] sectionIdsIn, int[] roleIdsIn) {
            return base.Channel.CreateEmployee(userIdIn, createdByIdin, sectionIdsIn, roleIdsIn);
        }
        
        public System.Threading.Tasks.Task<DecoreSysAdminFront.EmployeeServiceRef.EmployeeInfo> CreateEmployeeAsync(int userIdIn, int createdByIdin, int[] sectionIdsIn, int[] roleIdsIn) {
