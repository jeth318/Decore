...
namespace LoginServiceApplication.EmployeeServiceRef {
    ...
    public interface IEmployeeServiceWCF {
        ...
        LoginServiceApplication.EmployeeServiceRef.EmployeeInfo[] GetAllEmployees();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEmployeeServiceWCF/GetAllEmployees", ReplyAction="http://tempuri.org/IEmployeeServiceWCF/GetAllEmployeesResponse")]
        System.Threading.Tasks.Task<LoginServiceApplication.EmployeeServiceRef.EmployeeInfo[]> GetAllEmployeesAsync();
        ...
        LoginServiceApplication.EmployeeServiceRef.EmployeeInfo CreateEmployee(int userIdIn, int createdByIdin, int[] roleIds);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEmployeeServiceWCF/CreateEmployee", ReplyAction="http://tempuri.org/IEmployeeServiceWCF/CreateEmployeeResponse")]
        System.Threading.Tasks.Task<LoginServiceApplication.EmployeeServiceRef.EmployeeInfo> CreateEmployeeAsync(int userIdIn, int createdByIdin, int[] roleIds);
        ...
        LoginServiceApplication.EmployeeServiceRef.RoleInfo GetRoleById(int roleId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEmployeeServiceWCF/GetRoleById", ReplyAction="http://tempuri.org/IEmployeeServiceWCF/GetRoleByIdResponse")]
        System.Threading.Tasks.Task<LoginServiceApplication.EmployeeServiceRef.RoleInfo> GetRoleByIdAsync(int roleId);
    ...
    public partial class EmployeeServiceWCFClient : System.ServiceModel.ClientBase<LoginServiceApplication.EmployeeServiceRef.IEmployeeServiceWCF>, LoginServiceApplication.EmployeeServiceRef.IEmployeeServiceWCF {
        ...
        public LoginServiceApplication.EmployeeServiceRef.EmployeeInfo[] GetAllEmployees() {
            return base.Channel.GetAllEmployees();
        }
        
        public System.Threading.Tasks.Task<LoginServiceApplication.EmployeeServiceRef.EmployeeInfo[]> GetAllEmployeesAsync() {
            return base.Channel.GetAllEmployeesAsync();
        }
        
        public LoginServiceApplication.EmployeeServiceRef.EmployeeInfo CreateEmployee(int userIdIn, int createdByIdin, int[] roleIds) {
            return base.Channel.CreateEmployee(userIdIn, createdByIdin, roleIds);
        }
        
        public System.Threading.Tasks.Task<LoginServiceApplication.EmployeeServiceRef.EmployeeInfo> CreateEmployeeAsync(int userIdIn, int createdByIdin, int[] roleIds) {
        ...
        public LoginServiceApplication.EmployeeServiceRef.RoleInfo GetRoleById(int roleId) {
            return base.Channel.GetRoleById(roleId);
        }
        
        public System.Threading.Tasks.Task<LoginServiceApplication.EmployeeServiceRef.RoleInfo> GetRoleByIdAsync(int roleId) {
